                    ...
                    <form class="form-horizontal" action="<%=basePath%>/user/updatech.do" method="post">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control" id="upchapter" name="upchapter">
                                    </select>
                                    <select class="form-control" id="upchaptertwo" name="upchaptertwo"></select>
                                </div>
                            </div>
                            <div class="form-group">
    ...
    function trash(id) {
        if (!id) {
            ...
            $(".delSure").click(function () {
                $.ajax({
                    url: '<%=basePath%>/user/deletech.do?id=+i',
                    type: 'POST',
                    success: function (data) {
                        $("body").html(data);
                    }

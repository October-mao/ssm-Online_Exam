        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    <li>
                        <a href="<%=basePath%>/teacher/tologin.do"><i class="fa fa-dashboard fa-fw"></i>首页</a>
                    </li>
                    <li>
    ...
    <div id="page-wrapper">
        ...
        <div class="form-group" style="width: 10%; margin: 0px ;display: inline" >
           ...
           <button class="btn btn-outline btn-primary" data-toggle="modal" data-target="#myModa_n">添加</button>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <form style="margin:0px;display:inline;" method="post" enctype="multipart/form-data">
                <input style="display: inline"  type="file" name="file"/>
                <input style="display: inline ; width: 5%" type="submit" name="submit" onclick="alert('上传成功');" value="上传" />
            </form>
        <br>
...
<script>
    ...
    function search(){
        ...
        $.ajax({
            type: "POST",
            cache: false,
            url: "<%=basePath%>/student/byclassname.do",
